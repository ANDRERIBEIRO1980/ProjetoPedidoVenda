	...
	public void execute(Connection connection) throws SQLException {
		try {
			...
			if (this.relatorioGerado) {
				...
				// método que desta forma o arquivo pdf será salvo na maquina do
				// cliente,
				// abrindo o dialogo para salvar o arquivo
				// se comentado abrirá na pagina
				// se descomentado irá abrir dialogo de download
				// response.setHeader("Content-Disposition", "attachment;
				// filename=\"" + this.nomeArquivoSaida + "\"");
