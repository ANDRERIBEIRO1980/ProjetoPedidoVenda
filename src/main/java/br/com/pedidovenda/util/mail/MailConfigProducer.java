...
public class MailConfigProducer {
	...
	public SessionConfig getMailConfig() throws IOException {
		...
		//props.load(getClass().getResourceAsStream("/mail.properties")); a partir do src/main/resource
		InputStream inFile = new FileInputStream((new File("D:\\pedido-venda-jsf-mail.properties")).getAbsoluteFile()); //a partir de um arquivo externo
		props.load(inFile);                  
